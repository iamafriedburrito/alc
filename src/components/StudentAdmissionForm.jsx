...
const StudentAdmissionForm = () => {
    const {
        ...
        defaultValues: {
            ...
            state: "Maharashtra",
            district: "",
            // photo: null, // File uploads commented out for now
            // signature: null,
            affirmation: false,
        },
        mode: "onBlur",
    ...
    const onSubmit = async (data) => {
        try {
            // Transform data to uppercase for text fields
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className={`w-full px-4 py-3 rounded-xl border transition-all duration-200 ease-in-out bg-white/50 backdrop-blur-sm resize-none ${errors.correspondenceAddress
                                                ? "border-red-300 focus:ring-red-500 focus:border-red-500"
                                                : "border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                            }`}
                                    />
