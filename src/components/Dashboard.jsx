    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const [
                ...
                fetch(`${API_BASE}/followups/stats`).catch(() => ({
                    ok: false,
                })),
            ...
            if (!statsResponse.ok) {
                setStats((prev) => ({
                    ...prev,
                    totalAdmissions: admissionsData.total || 0,
                }));
            }
    ...
    const tips = [
        {
            ...
            content:
                "Use the quick actions to add new enquiries and admissions faster. Regular follow-ups increase conversion rates by 40%.",
        ...
        },
        {
            title: "📊 Daily Insight",
            content:
                "Track your enquiry-to-admission ratio to optimize your marketing strategies and improve student recruitment.",
        ...
        },
        {
            title: "🎯 Best Practice",
            content:
                "Update student information regularly and maintain detailed follow-up records to improve conversion rates.",
        ...
        },
        {
            title: "📈 Growth Tip",
            content:
                "Analyze peak enquiry periods and optimize your course offerings accordingly for better results.",
    ...
    return error ? (
        ...
        <div className="max-w-5xl mx-auto space-y-8">
            ...
            <div className="bg-white rounded-3xl shadow-sm p-8 border border-white/20">
                <div className="text-center">
                    ...
                    <p className="text-gray-600 text-lg">
                        Manage your institute efficiently with our comprehensive
                        system
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div
                    className="bg-white rounded-2xl shadow-sm p-6 border border-white/20 hover:shadow-sm transition-all duration-300 cursor-pointer"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-2xl shadow-sm p-6 border border-white/20">
                    ...
                    <div
                        className={`${randomTip.bgClass} p-4 rounded-lg border-l-4 ${randomTip.borderClass}`}
                    >
                        <h4
                            className={`font-medium mb-2 ${randomTip.titleClass}`}
                        >
                            {randomTip.title}
                        </h4>
                        ...
                        {displayedEnquiries.length > 0 ? (
                            displayedEnquiries.map((enquiry) => (
                                <div
                                    ...
                                    className="flex items-center space-x-6 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer"
                                    onClick={() =>
                                        handleNavigation(
                                            `/enquiry/${enquiry.id || enquiry.enquiryId}`,
                                        )
                                    }
                                >
                    ...
                    <div className="space-y-4">
                        {displayedAdmissions.length > 0 ? (
                            displayedAdmissions.map((admission) => (
                                <div
                                    key={admission.id || admission.admissionId}
                                    className="flex items-center space-x-6 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer"
                                    onClick={() =>
                                        handleNavigation(
                                            `/admission/${admission.id || admission.admissionId}`,
                                        )
                                    }
                                >
                                    <img
