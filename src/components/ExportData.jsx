      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="border border-gray-200 rounded-lg p-6 flex flex-col h-full">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Students Data</h3>
              <p className="text-sm text-gray-600">Export all student records</p>
            </div>
          </div>
        ...
        <div className="border border-gray-200 rounded-lg p-6 flex flex-col h-full">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Enquiries Data</h3>
              <p className="text-sm text-gray-600">Export all enquiry records</p>
            </div>
          </div>
          <div className="mt-auto">
            <button
        ...
        <div className="border border-gray-200 rounded-lg p-6 flex flex-col h-full">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Attendance Data</h3>
        ...
        <div className="border border-gray-200 rounded-lg p-6 flex flex-col h-full">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Followups Data</h3>
              <p className="text-sm text-gray-600">Export followup records</p>
            </div>
          </div>
          <div className="mt-auto">
            <button
        ...
        <div className="border border-gray-200 rounded-lg p-6 flex flex-col h-full">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Courses Data</h3>
              <p className="text-sm text-gray-600">Export course records</p>
            </div>
          </div>
          <div className="mt-auto">
            <button
        ...
        <div className="border border-gray-200 rounded-lg p-6 flex flex-col h-full">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Documents Data</h3>
              <p className="text-sm text-gray-600">Export document records</p>
            </div>
          </div>
          <div className="mt-auto">
            <button
