                ...
                <div className="p-8">
                    ...
                    <div className="mb-6 p-4 bg-blue-50 rounded-lg">
                        ...
                        <p className="text-sm text-gray-600">
                            Course: {student.courseName} • Mobile: {student.mobileNumber}
                        </p>
                    </div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (Number(value) > paymentStatus.balance) {
                                            ...
                                            toast && toast.warn('Amount cannot exceed the balance due.');
                                        }
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (intValue > maxDiscount) {
                                            ...
                                            toast && toast.warn('Discount cannot exceed the payment amount.');
                                        }
