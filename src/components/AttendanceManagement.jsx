...
import { CheckCircle, XCircle, Users, Filter, Save, RefreshCw } from 'lucide-react';
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="bg-white rounded-3xl shadow-sm p-8 border border-white/20 mb-6">
                    <div className="text-center">
                        ...
                        <p className="text-gray-600 text-lg">Mark and manage daily student attendance by batch</p>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 flex-wrap">
                        <div className="flex flex-1 gap-3 items-center">
                            ...
                            {selectedBatch && (
                                <div className="inline-flex items-center gap-2 bg-blue-50/80 border border-blue-100 rounded-xl px-4 py-3 text-sm font-medium text-blue-900 h-12">
                                    ...
                                    <span>Total: <span className="font-semibold">{students.length}</span></span>
                                </div>
                            )}
                        </div>
                        <div className="flex items-center gap-3 flex-shrink-0 flex-wrap">
                            ...
                            <button
                                ...
                                disabled={saving || !selectedBatch || students.length === 0}
