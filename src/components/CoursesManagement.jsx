            ...
            <div className="max-w-5xl mx-auto space-y-8">
                ...
                <div className="bg-white rounded-3xl shadow-sm p-8 border border-white/20">
                    <div className="text-center">
                        <h1 className="text-4xl font-bold text-gray-900 mb-3">Course Management</h1>
                        <p className="text-gray-600 text-lg">Create, update or delete courses</p>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="inline-flex items-center gap-2 bg-blue-50/80 border border-blue-100 rounded-xl px-4 py-3 text-sm font-medium text-blue-900 h-12">
                                ...
                                <span>Total: <span className="font-semibold">{totalCourses}</span></span>
                            </div>
                            <button
                                onClick={() => openModal()}
