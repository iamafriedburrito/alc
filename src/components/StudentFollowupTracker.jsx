                        ...
                        {filteredEnquiries.length === 0 ? (
                            ...
                            filteredEnquiries.map((enquiry) => {
                                ...
                                return (
                                    <div
                                        key={enquiry.id}
                                        className={`bg-white/50 backdrop-blur-sm p-6 rounded-2xl shadow-sm border transition-all duration-300 hover:shadow-md ${isOverdue ? 'border-red-200 bg-red-50/30' : 'border-gray-100'
                                            }`}
                                    >
